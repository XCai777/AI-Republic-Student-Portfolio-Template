...
export const metadata: Metadata = {
  title: 'AI Engineer Portfolio | Xiorence Cai',
  description: 'AI Engineer specializing in LLM',
};
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <span className="text-purple-300">xiorence_cai777@yahoo.com</span>
                <span className="text-purple-300">+63 917 826 6820</span>
              </div>
              <div className="text-purple-300">Stay Connected</div>
              <div className="flex gap-4">
                <a href="https://github.com/XCai777" className="text-purple-400 hover:text-purple-300 transition-colors duration-200">
                ...
                <a href="https://www.linkedin.com/in/xiorence-cai-1b7a80179/" className="text-purple-400 hover:text-purple-300 transition-colors duration-200">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
